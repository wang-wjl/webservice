 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservice.wjl.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservice.wjl.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservice.wjl.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.wjl.com/", "HelloServicePort"), HelloService.class, features);
    }
